...
BEGIN
  ...
  -- Inserisce con last_payout_at = now() così il primo interesse arriva 24h dopo
  INSERT INTO investments (user_id, plan_id, plan_name, amount, days_remaining, status, last_payout_at)
  VALUES (p_user_id, p_plan_id, p_plan_name, p_amount, p_duration, 'active', now())
