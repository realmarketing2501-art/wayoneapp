...
BEGIN
  ...
  INSERT INTO public.wallet_transactions (
    ...
    p_user_id, v_type, v_dir, v_abs, 'USDT', 'completed',
...
REVOKE ALL ON FUNCTION public.admin_credit_user(uuid, numeric, text) FROM public;
GRANT EXECUTE ON FUNCTION public.admin_credit_user(uuid, numeric, text) TO authenticated;
