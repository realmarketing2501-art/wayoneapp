...
const it = {
  ...
  hero: {
    tag: 'La piattaforma di investimento USDC',
    title_a: 'Investi', title_b: 'in modo', title_c: 'intelligente in', title_d: 'USDC',
  ...
  screens: {
    ...
    sub: "USDC è progettata per offrire un'esperienza semplice, trasparente e orientata al controllo della propria attività.",
    items: [
  ...
  flow: {
    ...
    items: [
      ...
      { title: 'Deposita', desc: 'USDC TRC-20 con accredito automatico.' },
  ...
  bonuses: {
    ...
    items: [
      { title: 'Primo referral',    when: '1° invitato che investe',          reward: '5 USDC' },
      { title: 'Super reclutatore', when: '10 referral diretti attivi',       reward: '75 USDC' },
      { title: 'Diamond recruiter', when: '50 referral diretti attivi',       reward: '500 USDC' },
      { title: 'Volume 500+',       when: 'Investimento personale > 500',     reward: '15 USDC' },
      { title: 'Volume 2.000+',     when: 'Investimento personale > 2.000',   reward: '75 USDC' },
      { title: 'Volume 5.000+',     when: 'Investimento personale > 5.000',   reward: '250 USDC' },
    ],
  },
  ranks: {
    ...
    items: [
      { name: 'Standard', volume: '< 5.000 USDC',   bonus: 'Nessuno',       extra: '—' },
      { name: 'Gold',     volume: '> 5.000 USDC',   bonus: '+0,5%/giorno',  extra: 'Badge + supporto prioritario' },
      { name: 'Platinum', volume: '> 20.000 USDC',  bonus: '+0,75%/giorno', extra: 'Badge + fee prelievo 0' },
      { name: 'Diamond',  volume: '> 100.000 USDC', bonus: '+1,0%/giorno',  extra: 'Badge + account manager' },
    ],
  },
  cta: {
    title_a: 'Inizia oggi con', title_b: 'USDC',
    sub: 'Crea il tuo account, deposita i primi USDC e attiva il tuo piano in pochi minuti.',
    btn: 'Crea account',
  },
  footer: { rights: 'Tutti i diritti riservati.' },
  phone: {
    welcome: 'Benvenuto in USDC', tagline: 'Investi in modo intelligente.\nCostruisci il tuo futuro.',
    register: 'Registrati', signin: 'Accedi',
    balance: 'Saldo USDC', overview: 'Panoramica',
...
const en: typeof it = {
  ...
  hero: {
    tag: 'The USDC investment platform',
    title_a: 'Invest', title_b: 'smart', title_c: 'in', title_d: 'USDC',
  ...
  screens: {
    ...
    sub: 'USDC is designed to deliver a simple, transparent experience focused on control of your activity.',
    items: [
  ...
  flow: {
    ...
    items: [
      ...
      { title: 'Deposit', desc: 'USDC TRC-20 with auto-credit.' },
  ...
  bonuses: {
    ...
    items: [
      { title: 'First referral',     when: '1st invitee who invests',         reward: '5 USDC' },
      { title: 'Super recruiter',    when: '10 active direct referrals',      reward: '75 USDC' },
      { title: 'Diamond recruiter',  when: '50 active direct referrals',      reward: '500 USDC' },
      { title: 'Volume 500+',        when: 'Personal investment > 500',       reward: '15 USDC' },
      { title: 'Volume 2,000+',      when: 'Personal investment > 2,000',     reward: '75 USDC' },
      { title: 'Volume 5,000+',      when: 'Personal investment > 5,000',     reward: '250 USDC' },
    ],
  },
  ranks: {
    ...
    items: [
      { name: 'Standard', volume: '< 5,000 USDC',   bonus: 'None',          extra: '—' },
      { name: 'Gold',     volume: '> 5,000 USDC',   bonus: '+0.5%/day',     extra: 'Badge + priority support' },
      { name: 'Platinum', volume: '> 20,000 USDC',  bonus: '+0.75%/day',    extra: 'Badge + 0 withdraw fee' },
      { name: 'Diamond',  volume: '> 100,000 USDC', bonus: '+1.0%/day',     extra: 'Badge + account manager' },
    ],
  },
  cta: {
    title_a: 'Start today with', title_b: 'USDC',
    sub: 'Create your account, deposit your first USDC and activate your plan in minutes.',
    btn: 'Create account',
  },
  footer: { rights: 'All rights reserved.' },
  phone: {
    welcome: 'Welcome to USDC', tagline: 'Invest smart.\nBuild your future.',
    register: 'Sign up', signin: 'Sign in',
    balance: 'USDC Balance', overview: 'Overview',
...
const es: typeof it = {
  ...
  hero: {
    tag: 'La plataforma de inversión en USDC',
    title_a: 'Invierte', title_b: 'de forma', title_c: 'inteligente en', title_d: 'USDC',
  ...
  screens: {
    ...
    sub: 'USDC está diseñada para una experiencia simple y transparente, centrada en el control de tu actividad.',
    items: [
  ...
  flow: {
    ...
    items: [
      ...
      { title: 'Deposita', desc: 'USDC TRC-20 con abono automático.' },
  ...
  bonuses: {
    ...
    items: [
      { title: 'Primer referido',     when: '1er invitado que invierte',        reward: '5 USDC' },
      { title: 'Super reclutador',    when: '10 referidos directos activos',    reward: '75 USDC' },
      { title: 'Diamond recruiter',   when: '50 referidos directos activos',    reward: '500 USDC' },
      { title: 'Volumen 500+',        when: 'Inversión personal > 500',         reward: '15 USDC' },
      { title: 'Volumen 2.000+',      when: 'Inversión personal > 2.000',       reward: '75 USDC' },
      { title: 'Volumen 5.000+',      when: 'Inversión personal > 5.000',       reward: '250 USDC' },
    ],
  },
  ranks: {
    ...
    items: [
      { name: 'Standard', volume: '< 5.000 USDC',   bonus: 'Ninguno',       extra: '—' },
      { name: 'Gold',     volume: '> 5.000 USDC',   bonus: '+0,5%/día',     extra: 'Insignia + soporte prioritario' },
      { name: 'Platinum', volume: '> 20.000 USDC',  bonus: '+0,75%/día',    extra: 'Insignia + comisión retiro 0' },
      { name: 'Diamond',  volume: '> 100.000 USDC', bonus: '+1,0%/día',     extra: 'Insignia + account manager' },
    ],
  },
  cta: {
    title_a: 'Empieza hoy con', title_b: 'USDC',
    sub: 'Crea tu cuenta, deposita tus primeros USDC y activa tu plan en minutos.',
    btn: 'Crear cuenta',
  },
  footer: { rights: 'Todos los derechos reservados.' },
  phone: {
    welcome: 'Bienvenido a USDC', tagline: 'Invierte inteligente.\nConstruye tu futuro.',
    register: 'Regístrate', signin: 'Entrar',
    balance: 'Saldo USDC', overview: 'Resumen',
...
const fr: typeof it = {
  ...
  hero: {
    tag: "La plateforme d'investissement USDC",
    title_a: 'Investissez', title_b: 'de façon', title_c: 'intelligente en', title_d: 'USDC',
  ...
  screens: {
    ...
    sub: "USDC offre une expérience simple et transparente, axée sur le contrôle de votre activité.",
    items: [
  ...
  flow: {
    ...
    items: [
      ...
      { title: 'Déposer', desc: 'USDC TRC-20 avec crédit automatique.' },
  ...
  bonuses: {
    ...
    items: [
      { title: 'Premier parrainage', when: '1er filleul qui investit',           reward: '5 USDC' },
      { title: 'Super recruteur',    when: '10 filleuls directs actifs',         reward: '75 USDC' },
      { title: 'Diamond recruiter',  when: '50 filleuls directs actifs',         reward: '500 USDC' },
      { title: 'Volume 500+',        when: 'Investissement personnel > 500',     reward: '15 USDC' },
      { title: 'Volume 2 000+',      when: 'Investissement personnel > 2 000',   reward: '75 USDC' },
      { title: 'Volume 5 000+',      when: 'Investissement personnel > 5 000',   reward: '250 USDC' },
    ],
  },
  ranks: {
    ...
    items: [
      { name: 'Standard', volume: '< 5 000 USDC',   bonus: 'Aucun',         extra: '—' },
      { name: 'Gold',     volume: '> 5 000 USDC',   bonus: '+0,5%/jour',    extra: 'Badge + support prioritaire' },
      { name: 'Platinum', volume: '> 20 000 USDC',  bonus: '+0,75%/jour',   extra: 'Badge + frais retrait 0' },
      { name: 'Diamond',  volume: '> 100 000 USDC', bonus: '+1,0%/jour',    extra: 'Badge + account manager' },
    ],
  },
  cta: {
    title_a: "Commencez aujourd'hui avec", title_b: 'USDC',
    sub: 'Créez votre compte, déposez vos premiers USDC et activez votre plan en quelques minutes.',
    btn: 'Créer un compte',
  },
  footer: { rights: 'Tous droits réservés.' },
  phone: {
    welcome: 'Bienvenue sur USDC', tagline: 'Investissez intelligemment.\nConstruisez votre avenir.',
    register: "S'inscrire", signin: 'Connexion',
    balance: 'Solde USDC', overview: 'Aperçu',
...
const zh: typeof it = {
  ...
  hero: {
    tag: 'USDC 投资平台',
    title_a: '智慧', title_b: '投资', title_c: '于', title_d: 'USDC',
  ...
  screens: {
    ...
    sub: 'USDC 致力于提供简洁透明的体验，让您完全掌控自己的活动。',
    items: [
  ...
  flow: {
    ...
    items: [
      ...
      { title: '充值', desc: 'USDC TRC-20 自动入账。' },
  ...
  bonuses: {
    ...
    sub: '网络成长每个阶段的奖励。',
    items: [
      { title: '首位推荐',     when: '第 1 位投资的邀请',         reward: '5 USDC' },
      { title: '超级推荐人',   when: '10 位活跃直接推荐',         reward: '75 USDC' },
      { title: '钻石推荐人',   when: '50 位活跃直接推荐',         reward: '500 USDC' },
      { title: '体量 500+',    when: '个人投资 > 500',            reward: '15 USDC' },
      { title: '体量 2,000+',  when: '个人投资 > 2,000',          reward: '75 USDC' },
      { title: '体量 5,000+',  when: '个人投资 > 5,000',          reward: '250 USDC' },
    ],
  },
  ranks: {
    ...
    volume_label: '网络体量',
    items: [
      { name: 'Standard', volume: '< 5,000 USDC',   bonus: '无',          extra: '—' },
      { name: 'Gold',     volume: '> 5,000 USDC',   bonus: '+0.5%/天',    extra: '徽章 + 优先支持' },
      { name: 'Platinum', volume: '> 20,000 USDC',  bonus: '+0.75%/天',   extra: '徽章 + 提现 0 手续费' },
      { name: 'Diamond',  volume: '> 100,000 USDC', bonus: '+1.0%/天',    extra: '徽章 + 客户经理' },
    ],
  },
  cta: {
    title_a: '今天就开始使用', title_b: 'USDC',
    sub: '创建账户，充值首笔 USDC，几分钟内激活您的计划。',
    btn: '创建账户',
  },
  footer: { rights: '版权所有。' },
  phone: {
    welcome: '欢迎使用 USDC', tagline: '智慧投资。\n建设你的未来。',
    register: '注册', signin: '登录',
    balance: 'USDC 余额', overview: '概览',
